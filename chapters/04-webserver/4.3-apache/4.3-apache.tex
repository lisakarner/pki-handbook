...
Dieser Part unterscheidet sich nicht von Nginx. Auch hier müssen die Zertifikate aus XCA exportiert und auf dem Server gespeichert werden. Die Schritte dazu sind in Abschnitt \ref{sec:export-certificates} beschrieben.
