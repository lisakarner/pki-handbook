\section{Konfiguration einer PKI in XCA}
\subsection{Installation von XCA}
...
\subsection{Erstellen der Zertifikatsdatenbank}
...
\subsection{Erstellung der benötigten Zertifikate}
...
\newpage
\input{chapters/03-konfiguration-einer-pki/root-ca.tex}

\newpage
\input{chapters/03-konfiguration-einer-pki/intermediate-cert.tex}

\newpage
\input{chapters/03-konfiguration-einer-pki/tls-cert.tex}
